...
quietly infix                ///
  ...
  int     bpl       116-118  ///
  long    bpld      119-123  ///
  byte    citizen   124-124  ///
  byte    school    125-125  ///
  byte    educ      126-127  ///
  int     educd     128-130  ///
  byte    empstat   131-131  ///
  byte    empstatd  132-133  ///
  byte    labforce  134-134  ///
  int     occ       135-138  ///
  byte    wkswork2  139-139  ///
  byte    uhrswork  140-141  ///
  long    inctot    142-148  ///
  long    incwage   149-154  ///
  long    incwelfr  155-159  ///
  int     poverty   160-162  ///
  int     departs   163-166  ///
  int     arrives   167-170  ///
  using `"usa_00147.dat"'
...
drop mult sample serial cbs hhwt cluster strata gq raced hispand educ empstatd

compress
save usa_00147.dta, replace
